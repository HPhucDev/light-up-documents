...
export default function PageHome() {
  ...
  useEffect(() => {
    function scrollListener() {
      setIsNavbarTranslucent(
        window.scrollY <= NAVBAR_TRANSLUCENT_UNTIL_SCROLL_Y
      );
    }
  ...
  return (
    <Layout title={content.page.title} description={content.page.description}>
      ...
      <main className={clsx("font-poppins", styles.home)}>
        <Hero id="homeHero">
          <Container>
            <HeroTitle>{content.page.title}</HeroTitle>
                      ...
                      {carouselCardButtonProps && (
                        <div className={styles.home__carousel__cta}>
                          <Button size="huge" {...carouselCardButtonProps}>
                            {carouselCardButtonProps.children ||
                              carouselCardButtonProps.label}
                          </Button>
                        </div>
                      )}
                    </Card>
                  ...
                  return (
                    ...
                    >
                      <Card to={categoryItemCardLink}>
                        {categoryItemCardTitle && (
                          <CardTitle withArrow>
                            {categoryItemCardTitle}
                          </CardTitle>
                        )}
                        {categoryItemCardDescription && (
                          <CardDescription>
                            {categoryItemCardDescription}
                          </CardDescription>
                        )}
                        {categoryItemCardImgSrc && (
                          <CardImg src={categoryItemCardImgSrc} />
                        )}
                      </Card>
                      {categoryItem.links && (
                        <FeaturesList
